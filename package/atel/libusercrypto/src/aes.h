...
void aes_encrypt_libusercrypto(const BYTE in[],             // 16 bytes of plaintext
                 BYTE out[],                  // 16 bytes of ciphertext
                 const WORD key[],            // From the key setup
                 int keysize);                // Bit length of the key, 128, 192, or 256

void aes_decrypt_libusercrypto(const BYTE in[],             // 16 bytes of ciphertext
...
typedef int (*crypt_test_cb)(const char **ori_ctx, unsigned int length, char **new_ctx);
...
/*
this function is to generate plain/encrypt file
*********************************
file_src: source file
file_dst: destinate file
crypt_type: encrypt or decrypt
*/
