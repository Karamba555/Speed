...
#define QWDS_PKT_DATA_UNKNOWN          0x00
...
#define QMINAS_GET_SYSTEM_SELECTION_PREFERENCE  0x0034
...
#define QMINAS_GET_TX_RX_INFO                   0x005A
...
typedef struct _QMINAS_GET_TX_RX_INFO_REQ_MSG
{
   USHORT Type;             // QMUX type 0x0003
   USHORT Length;
   UCHAR  TLVType;
   USHORT TLVLength;
   UCHAR  RadioType;
} QMINAS_GET_TX_RX_INFO_REQ_MSG, *PQMINAS_GET_TX_RX_INFO_REQ_MSG;


typedef struct _QMINAS_GET_TX_RX_INFO_RESP_MSG
{
   UCHAR  Type;             
   USHORT Length;
   UCHAR  Tuned;
   ...
   INT    Rsrp;
   UINT   Phase;
} QMINAS_GET_TX_RX_INFO_RESP_MSG, *PQMINAS_GET_TX_RX_INFO_RESP_MSG;
...
typedef struct _QMINAS_GET_IF_LTE_INFO_V2
{
   UCHAR  TLVType;
   USHORT TLVLength;    
   UCHAR  Idle;
   ...
   USHORT AreaCode;
   UINT   GlobalCellID;
   USHORT EUTRAChannelNumber;
   USHORT ServingCellID;   
} QMINAS_GET_IF_LTE_INFO_V2, *PQMINAS_GET_IF_LTE_INFO_V2;
...
typedef struct _QMINAS_GET_SYSTEM_SELECTION_LTE_BAND_RESP_MSG
{
   UCHAR Type;             
   UCHAR Length;              // 8
  // UCHAR  TLVType;          // 0x02 - result code
   //USHORT TLVLength;        // 8
   UCHAR  Value[8];
} QMINAS_GET_SYSTEM_SELECTION_LTE_BAND_RESP_MSG, *PQMINAS_GET_SYSTEM_SELECTION_LTE_BAND_RESP_MSG;
...
typedef struct _QMUX_MSG
{
   ...
   union
   {
      ...
      QMINAS_GET_TX_RX_INFO_REQ_MSG             GetTxRxInfoReq;
      QMINAS_GET_TX_RX_INFO_RESP_MSG            GetTxRxInfoResp;
