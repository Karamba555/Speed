...
$(build/stamp-install): $(package/stamp-install)
$(target/stamp-install): $(package/stamp-compile) $(build/stamp-install)
$(build/stamp-modify): $(target/stamp-install)
...
world: prepare $(target/stamp-compile) $(package/stamp-compile) $(package/stamp-install) $(build/stamp-install) $(target/stamp-install) $(build/stamp-modify) FORCE
