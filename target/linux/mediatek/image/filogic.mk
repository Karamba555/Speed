...
define Device/ATEL-SW120
  DEVICE_VENDOR := MediaTek
  DEVICE_MODEL := ATEL-SW120
  DEVICE_DTS := ATEL-SW120
  DEVICE_DTS_DIR := ../dts
  SUPPORTED_DEVICES := mediatek,mt7981-spim-snand-rfb
  DEVICE_PACKAGES := kmod-mt7981-firmware mt7981-wo-firmware
  UBINIZE_OPTS := -E 5
  ...
  IMAGES += factory.bin 
  IMAGES += tmp.bin
  DEVICE_TITLE := ATEL-SW120
  IMAGE/tmp.bin := atel_nand
  IMAGE/factory.bin := append-ubi | check-size $$$$(IMAGE_SIZE) | atel_default
  IMAGE/sysupgrade.bin := sysupgrade-tar | atel_default | append-metadata
  DEVICE_COMPAT_VERSION := 1.1
  DEVICE_COMPAT_MESSAGE := Config cannot be migrated from swconfig to DSA
endef
TARGET_DEVICES += ATEL-SW120
